# CS 625, Fall 2026 Syllabus

[Download printable PDF version](https://github.com/odu-cs625-datavis/public-spring26-bhanuka/raw/main/syllabus.pdf)
...
* Email: [bhanuka@cs.odu.edu](mailto:bhanuka@cs.odu.edu) 
* Office: Monarch Hall, Room #2123C
* Office hours:
  ...
  * Zoom link: [CS 625 Office Hours](https://odu.zoom.us/j/94531879016?pwd=xVC3YiYQ1JnNkqM0aMWGLRiFGgdAKn.1)
* Open-door policy: Walk-ins are welcome outside office hours when my door is open or ajar

I use office hours to meet with students and answer questions about the course. You don't need an appointment for office hours, but I will give preference to appointments. 

When you join the meeting, if I'm not on camera/meeting, send me a message in Zoom Chat. If I'm already with another student, I will place you in the waiting room. If you encounter any issues, please email me to set up an appointment. 

We may have a Graduate Teaching Assistant (GTA) for the course, but they will be assigned after the semester begins. I will update their contact info on Canvas and GitHub as well.
...
All course materials will be made available in Canvas (<https://canvas.odu.edu/courses/212983/>) or via GitHub (<https://github.com/odu-cs625-datavis/public-fall26-bhanuka>).

### How to Be Successful in This Course

The weekly schedule will run **Monday - Sunday**.

Course materials for the coming week will be generally scheduled on **Monday morning**.

Each week there will be a reading assignment and set of Learning Checks to test your basic comprehension of the material. For weeks when we have a textbook reading, there will also be a video from Dr. Munzner, the textbook author, walking through the chapter. 

In addition, I will also include lecture videos from Dr. Weigle, the creator of CS 625 and CS 725, which include additional explanations and examples. 
...
* comprised of "meaningful interactions", which can include posting a question in the Canvas Discussion Board, providing the first correct/helpful answer to a classmate's question in the Discussion Board, posting about an interesting visualization in the Discussion Board, contributing to existing discussion topics posted by the instructor, attending office hours (or alternate meeting time) to ask a question, etc.
* rubric (0-4):
...
* for more information about the project refer the [project page](Semester-Project/project.md)
