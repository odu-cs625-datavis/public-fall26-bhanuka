...
* an idiom/mark/data/encode table (see [Idiom-Mark-Data-Encode Table Examples](../Idiom-Mark-Data-Encode/idiom-mark-data-encode-examples.md))
...
`https://github.com/odu-cs625-datavis/fall26-bhanuka-username/blob/main/HW3-report.md` 
