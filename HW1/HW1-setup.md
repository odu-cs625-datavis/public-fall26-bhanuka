...
You should be working in the private GitHub repo that I created for you in the [odu-cs625-datavis organization](https://github.com/odu-cs625-datavis/) (your repo URL should look something like https<nolink>://github.com/odu-cs625-datavis/fall26-bhanuka-*username*/).
...
* Click on HW1 in Canvas.
* Under "Assignment Submission", click the "Write Submission" button.
* Copy/paste the URL of your report into the edit box
  * should be something like https<nolink>://github.com/odu-cs625-datavis/fall26-bhanuka-*username*/blob/main/HW1-report.md
  * feel free to organize the files/folders inside your repository, we will be using GitHub for future submissions
